...
const year_three_one = Filters.filter((f) => (f. groupId === 3) && (f.semester === 1))
const year_three_two = Filters.filter((f) => (f. groupId === 3) && (f.semester === 2))

const year_four_one = Filters.filter((f) => (f. groupId === 4) && (f.semester === 1))
const year_four_two = Filters.filter((f) => (f. groupId === 4) && (f.semester === 2))
