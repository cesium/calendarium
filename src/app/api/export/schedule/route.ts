...
import { IFormatedShift } from "../../../schedule/page";
...
export async function GET(request: NextRequest) {
  ...
  const queryEntriesData: [string, string | string[]][] = Array.from(
  ...
  if (valid) {
    ...
    return new NextResponse(calendar.toString(), {
      ...
      headers: {
        ...
        "Content-Disposition": "attachment; filename=calendarium-schedule.ics",
      },
    });
  } else {
