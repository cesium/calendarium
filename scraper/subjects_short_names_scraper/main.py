...
filters_resp = get("https://raw.githubusercontent.com/cesium/calendarium/d595fdf2e60c4117fc8a38df1b1751d452c8993a/data/filters.json")
filters = json.loads(filters_resp.text)

print("Downloading and parsing `shifts.json` from Calendarium's GitHub repository\n")
shifts_resp = get("https://raw.githubusercontent.com/cesium/calendarium/d595fdf2e60c4117fc8a38df1b1751d452c8993a/data/shifts.json")
