...
const CalendarExportModal = ({
  ...
  function generateURL(): string {
    const baseURL: string =
      "https://calendario.cesium.di.uminho.pt/api/export?";
    var queries: string = "";
    ...
    if (isHome) {
      ...
      if (checkedEvents && checkedEvents.length > 0) {
        queries = `subjects=${checkedEvents.join(",")}`;
      } else {
        return "";
      }
    } else {
                  ...
                  >
                    ...
                    <Collapse.Panel header="Apple Calendar" key="2">
                      <div className="text-gray-900">
                        ...
                        {'"Calendars"'}.
                        <p />
                        <a className="font-bold">3.</a> On the bottom left,
                        click {'"Add Calendar"'}{" "}
                        <i className="bi bi-chevron-right"></i>{" "}
